...
> = {
  "software-developer": {
    ...
    challengePrompt: "Mini-challenge: Type the word 'start' to confirm the UI label.",
    correctAnswer: "start",
    successText: "You shipped the fix. Badge unlocked: Debugging Under Pressure.",
    retryText: "Close—debugging takes iteration. Review the prompt and try again.",
  },
  nurse: {
    title: "Nurse",
    scenario:
      "Two patients need attention. You must prioritize, assess symptoms, and communicate clearly.",
    challengePrompt: "Mini-challenge: Type the word 'assess' to choose the safest first step.",
    correctAnswer: "assess",
    successText: "You stayed calm and made a safe call. Badge unlocked: Patient Prioritization.",
    retryText: "Try again—focus on the safest first action.",
  },
  electrician: {
    title: "Electrician",
    scenario:
      "A room’s lights flicker. Diagnose the issue while following safety procedures.",
    challengePrompt: "Mini-challenge: Type 'power off' (two words) for the first safety step.",
    correctAnswer: "power off",
    successText: "Safety first. Badge unlocked: Safe Diagnostics.",
  ...
  if (!data) {
    return (
      <main style={{ minHeight: "100vh", padding: 24, maxWidth: 900, margin: "0 auto" }}>
        ...
        <Link href="/careers" style={{ fontWeight: 700, textDecoration: "none" }}>
          ← Back to Career Hub
        </Link>
      </main>
    );
  ...
  return (
    <main style={{ minHeight: "100vh", padding: 24, maxWidth: 900, margin: "0 auto" }}>
      <header style={{ display: "flex", justifyContent: "space-between", gap: 12, flexWrap: "wrap" }}>
        ...
        <Link href="/careers" style={{ alignSelf: "center", fontWeight: 700, textDecoration: "none" }}>
          ← Career Hub
        </Link>
      </header>
      ...
      <section style={{ marginTop: 14, border: "1px solid #ddd", borderRadius: 14, padding: 16 }}>
        ...
        <label style={{ display: "block", marginBottom: 8, fontWeight: 700 }} htmlFor="answer">
          Your answer
        </label>
        <input
          id="answer"
